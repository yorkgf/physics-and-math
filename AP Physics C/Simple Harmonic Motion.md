...
When we start the motion at $x = A$ with $t = 0$:
...
<img src="Assets/shm-xva-mpl.svg" width="600" alt="Graphs of x(t), v(t), a(t) for simple harmonic motion (generated by matplotlib)">
...
- When $|x| = A$ (maximum displacement): $K = 0$, $U = \frac{1}{2}kA^2 = E$ (all energy is potential)
- When $x = 0$ (at equilibrium): $U = 0$, $K = \frac{1}{2}kA^2 = E$ (all energy is kinetic)
- Energy continuously converts between potential and kinetic as the system oscillates

### Energy vs Displacement Graph

<img src="Assets/shm-energy-mpl.svg" width="550" alt="Kinetic energy and potential energy vs displacement for simple harmonic motion (generated by matplotlib)">
